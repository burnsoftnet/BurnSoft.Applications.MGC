...
### **HasWorkOrdersnAttached(String, Int64, String&)**

Determines whether [has work ordersn attached] [the specified database path].

```csharp
public static int HasWorkOrdersnAttached(string databasePath, long id, String& errOut)
```
...
### **UpdateSmithDetails(String, String, String, String&)**

Updates the collection.

```csharp
public static bool UpdateSmithDetails(string databasePath, string oldName, string newName, String& errOut)
```
...
```csharp
public static List<GunSmithContacts> Get(string databasePath, String& errOut)
```
...
[List&lt;GunSmithContacts&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1)<br>
...
```csharp
public static List<GunSmithContacts> Get(string databasePath, long id, String& errOut)
```
...
```csharp
public static List<GunSmithContacts> Get(string databasePath, string name, String& errOut)
```
