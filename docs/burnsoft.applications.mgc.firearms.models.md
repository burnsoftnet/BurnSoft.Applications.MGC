...
### **Add(String, String, Int64, String&)**

Adds the specified database path.

```csharp
public static bool Add(string databasePath, string name, long manufacturerId, String& errOut)
```
...
### **Update(String, Int64, String, Int64, String&)**

Updates the specified database path.

```csharp
public static bool Update(string databasePath, long id, string name, long manufacturerId, String& errOut)
```
...
### **Exists(String, String, Int64, String&)**

Existses the specified database path.

```csharp
public static bool Exists(string databasePath, string name, long manufacturerId, String& errOut)
```
...
```csharp
public static List<ModelList> Lists(string databasePath, long manufacturerId, String& errOut)
```
...
[List&lt;ModelList&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1)<br>
List&lt;ModelList&gt;.
...
```csharp
public static List<ModelList> Lists(string databasePath, String& errOut)
```
