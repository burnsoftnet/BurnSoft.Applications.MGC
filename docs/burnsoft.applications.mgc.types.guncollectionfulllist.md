...
`true` if this instance has accessory; otherwise, `false`.
...
[String](https://docs.microsoft.com/en-us/dotnet/api/system.string)<br>
The date time added in database.
...
[Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32)<br>
`true` if [item sold]; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if [was stolen]; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if [was sold]; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance is c and r; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance has mb; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance is in bound book; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance is class3 item; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance is clis competitionass3 item; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance has extra barrels; otherwise, `false`.
...
[Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)<br>
`true` if this instance has documents; otherwise, `false`.
