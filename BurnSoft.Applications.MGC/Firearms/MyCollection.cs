            ...
            try
            {
                ...
                foreach (DataRow d in dt.Rows)
                {
                    ...
                    lst.Add(new GunCollectionList()
                    {
                        ...
                        AppraisalDate = objDf.FormatDate(d["AppraisalDate"] != DBNull.Value ? d["AppraisalDate"].ToString().Trim() : ""),
                        ...
                        DateTimeAdded = objDf.FormatDate(d["dtp"] != DBNull.Value ? d["dtp"].ToString().Trim() : ""),
                        Importer = d["Importer"] != DBNull.Value ? d["Importer"].ToString().Trim() : "",
                        RemanufactureDate = objDf.FormatDate(d["ReManDT"] != DBNull.Value ? d["ReManDT"].ToString().Trim() : ""),
                        ...
                        DateOfCAndR = objDf.FormatDate(d["DateofCR"] != DBNull.Value ? d["DateofCR"].ToString().Trim() : ""),
